...
class Button2 extends StatelessWidget {
  ...
  final double width;
  final double height;
  const Button2({required this.textButton ,required this.onTap,required this.width,required this.height});
    ...
    return Container(
      ...
      child: ElevatedButton(onPressed: onTap, child:  Text(
        ...
        style: ButtonStyle(
          ...
          backgroundColor: MaterialStateProperty.all<Color>(Mycolors.buttonsos),
