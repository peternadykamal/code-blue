...
Future<void> testThis() async {
  ...
  //     userId1: 'sF6ja62XSTbToHzMih4HrbrMfgL2',
  //     userId2: 'ZidAyWx9HVafLj48IqBLtuMAqTp2');
  ...
  // List<Relation> list = await RelationRepository().getRelationsForCurrentUser();

  // print(list[0].userId1 + " " + list[0].userId2 + " " + list[0].id.toString());
  // print(list[1].userId1 + " " + list[1].userId2 + " " + list[1].id.toString());
  // print(list[2].userId1 + " " + list[2].userId2 + " " + list[2].id.toString());
